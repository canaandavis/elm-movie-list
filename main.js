...
var _user$project$SearchResults_Models$new = {
	results: {ctor: '[]'},
	formValue: '',
	isSearching: false
};
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_elm_lang$core$Json_Decode$list(_user$project$SearchResults_Commands$searchResultDecoder))));
};

var _user$project$SearchResults_Update$update = F2(
			...
			case 'SEARCH_RESULTS_NewSearchResults':
				if (_p0._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							searchResults,
							{results: _p0._0._0, isSearching: false}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
...
var _user$project$SearchResults_List$viewSearching = function (isSearching) {
	return isSearching ? A2(
...
var _user$project$SearchResults_List$viewSearchResult = function (searchResult) {
...
var _user$project$SearchResults_List$viewSearchResults = function (searchResults) {
	return A2(
...
var _user$project$SearchResults_List$view = function (searchResults) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('search-widget'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('MOVIES OR WHATEVER'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
